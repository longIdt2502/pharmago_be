...
func (server *ServerGRPC) DetailProduct(ctx context.Context, req *pb.DetailProductRequest) (*pb.DetailProductResponse, error) {
	...
	productPb := &pb.Product{
		...
		LieuDung:     productDb.LieuDung,
		ChiDinh:      productDb.ChiDinh,
		ChongChiDinh: &productDb.ChongChiDinh.String,
		CongDung:     productDb.CongDung,
		TacDungPhu:   productDb.TacDungPhu,
		ThanTrong:    productDb.ThanTrong,
		TuongTac:     &productDb.TuongTac.String,
		BaoQuan:      productDb.BaoQuan,
		DongGoi:      productDb.DongGoi,
		NoiSx:        productDb.Name_9.String,
		CongTyDk:     productDb.CongTyDk,
		CongTySx:     productDb.CongTySx,
		Image:        images,
	}
